...
const Loading = () => {
  const rowHead = "w-[120px] h-[80px] flex-shrink-0";
  const rowBody = "ml-0.5 w-full h-[80px]";
      ...
      <div className="m-auto flex min-h-screen w-full items-start overflow-x-auto overflow-y-hidden pt-page-top-space">
        <div className="flex flex-col-reverse lg:flex-row justify-center w-full gap-5 max-w-full">
          ...
          <div className="w-full lg:w-[260px] rounded-medium">
            <Skeleton className="w-full mb-5 h-[88px] rounded-medium" />
            <Skeleton className="w-full h-[197px] rounded-medium" />
          </div>
        </div>
      </div>
    </SectionContainer>
