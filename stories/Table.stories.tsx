...
import {Cell, Column, Row, Table, TableHeader} from "../src/components/ui/Table";
...
export const Example = (args: any) => {
  ...
  let items = useMemo(() => {
    ...
    let items = rows
      .slice()
      .sort((a, b) =>
        (a[sortDescriptor.column] as string).localeCompare(b[sortDescriptor.column] as string),
      );
